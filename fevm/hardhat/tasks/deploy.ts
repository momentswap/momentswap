...
import type { MomentSwapERC721 } from '../typechain-types/contracts/MomentSwapERC721';
import type { MomentSwapERC721__factory } from '../typechain-types/factories/contracts/MomentSwapERC721__factory';
...
task('deploy:MomentSwapERC721').setAction(
  async (taskArgs: TaskArguments, hre) => {
    ...
    const factory: MomentSwapERC721__factory = <MomentSwapERC721__factory>(
    ...
    const momentSwapERC721: MomentSwapERC721 = <MomentSwapERC721>await factory
      .deploy
      // {
