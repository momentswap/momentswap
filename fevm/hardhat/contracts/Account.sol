...
contract Account is IAccount {
    ...
    function getAddress(uint64[] calldata _accountIds) external view returns (address[] memory) {}
    function getAccountData(uint64[] calldata _accountIds) external view returns (AccountData[] memory) {}
    function getAvatarURI(uint64[] calldata _accountIds) external view returns (string[] memory) {}
